...
def compute_WBF(det_names, det_scores, det_boxes, iou_thresh=0.9, iou_thresh2=0.5, type='mean', retain_low=True):
    if len(det_names) == 0:
    ...
    for i, box in enumerate(det_boxes):
        ...
        elif iou_thresh2 <= max_iou < iou_thresh and score > 0.4 and retain_low:
            out_scores.append(0.4+0.2*((score-0.4)/0.6))
