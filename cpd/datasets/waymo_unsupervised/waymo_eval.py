...
def main():
    ...
    parser.add_argument('--pred_infos', type=str, default='/home/asc01/projects/OpenProjects/OpenPCDetV2/output/models/waymo_unsupervised/voxel_rcnn_cproto_center_si/default/eval/eval_with_train_0/epoch_18/val/result.pkl', help='pickle file')
