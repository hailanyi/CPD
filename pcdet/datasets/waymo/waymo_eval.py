...
def main():
    ...
    parser.add_argument('--pred_infos', type=str, default='/home/asc01/projects/OpenProjects/OpenPCDetV2/output/models/waymo/ins_labeled/origin/center_point_nolabel/centerpoint/default/eval/eval_with_train_0/epoch_28/val/result.pkl', help='pickle file')
    parser.add_argument('--gt_infos', type=str, default='/home/asc01/data/waymo/perception/waymo_infos_val.pkl', help='pickle file')
