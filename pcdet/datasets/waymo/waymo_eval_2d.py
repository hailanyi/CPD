...
def main():
    ...
    parser.add_argument('--pred_infos', type=str, default='/home/asc01/projects/OpenProjects/OpenPCDetV2/output/models/waymo/center_point/centerpoint/default/eval/eval_with_train_0/epoch_25/val/result.pkl', help='pickle file')
